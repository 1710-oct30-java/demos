...
public class Reimbursement {
	...
	public Reimbursement(int id, int amount, Time submitted, Time resolved, String description, int authorId,
	...
	public Reimbursement(int amount, Time submitted, Time resolved, String description, int authorId,
			int resolverId, int status, int type) {
		this.amount = amount;
		this.submitted = submitted;
		this.resolved = resolved;
