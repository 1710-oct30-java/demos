...
function reverseStr(someStr) {
    ...
    for (var i = 0; i < someStr.length; i++) {
        newString += someStr[someStr.length - 1 - i]
    }
    return newString;
...
function substr(someStr, length, offset){
    ...
    if(typeof someStr !== 'string' && typeof length !== 'number' && typeof offset !== 'number'){
        alert('Invalid! Please enter a string, and two integer values separated by commas. Like ("hello", 2,3) ');
    }
