...
public class Question8
{
	...
	// Determines if String s is a palindrome by looping through each character and comparing
	// it to the character on the opposite end. If a mismatch is found, returns false. Otherwise,
	// returns true.
	//
	// This example was taken from URL https://stackoverflow.com/questions/8444710/java-way-to-check-if-a-string-is-palindrome
