...
public class Question4 {
	...
	public static void main(String[] args) {
		...
		// multiplying in ascending order is the exact same as multiplying in descending
		// order
		for (int i = 1; i <= factNum; i++) {
			// BigInt's only take strings to instantiate and BigInt's can only multiply with
			// other BigInts
