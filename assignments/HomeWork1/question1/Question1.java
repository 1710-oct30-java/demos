...
public class Question1 {
	...
	/*BubbleSort:  Compare each adjacent number and switch is the number on
	...
	*/
	public static int[] bubbleSort(int[] array)
	{
		...
		do
		{
			...
			{
				//if at the end of the array then continue
				if(i + 1 == array.length) continue;
				//if the current number is greater than the next number then swap numbers and increment count
