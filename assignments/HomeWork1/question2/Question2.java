...
public class Question2 {
	...
	public static void main(String[] args) {
		int num1 = 0;
		int num2 = 1;
		//count is number of repetition through, however minus 2 because we will print the first 2 in the main statement
		int count = 25 - 2;
	...
	private static void fib(int num1,int num2, int count)
	{
